  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-gray-100">
      <div className="bg-white p-6 rounded-2xl shadow-lg w-96">
        ...
        <div className="mb-4">
          <label className="block text-gray-600 text-sm font-medium">Senha:</label>
          <p className="bg-gray-200 p-2 rounded-md">********</p>
        </div>
        
        <div className="mb-4">
          <label className="block text-gray-600 text-sm font-medium">Cargo:</label>
        ...
        <div className="flex gap-4">
          ...
          <button onClick={handleLogout} className="flex-1 bg-red-500 text-white py-2 rounded-md hover:bg-red-600 transition">
            Sair
          </button>
        </div>
      </div>
